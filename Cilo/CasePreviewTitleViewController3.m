...
@interface CasePreviewTitleViewController3 (){
    NSTimer *blinkTimer;
}

@end

@implementation CasePreviewTitleViewController3
...
- (IBAction)saveButtonPressed:(id)sender {
    ...
    [_hud setLabelText:[NSString stringWithFormat:@"儲存見面時間，請稍候"]];
    [_hud setDimBackground:YES];
    
    PFObject *saveCasePreview = (PFObject *)_detailItem;
    [saveCasePreview setObject:_textView.text forKey:@"endTime"];
