...
@interface CasePreviewTitleViewController4 (){
    NSTimer *blinkTimer;
}

@end

@implementation CasePreviewTitleViewController4
...
- (IBAction)saveButtonPressed:(id)sender {
    ...
    [_hud setLabelText:[NSString stringWithFormat:@"儲存活動區域，請稍候"]];
    [_hud setDimBackground:YES];
    
    PFObject *saveCasePreview = (PFObject *)_detailItem;
    [saveCasePreview setObject:_textView.text forKey:@"toAddress"];
