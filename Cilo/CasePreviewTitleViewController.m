...
@interface CasePreviewTitleViewController (){
    NSTimer *blinkTimer;
}

@end

@implementation CasePreviewTitleViewController
...
- (IBAction)saveButtonPressed:(id)sender {
    ...
    [_hud setLabelText:[NSString stringWithFormat:@"儲存請教的問題，請稍候"]];
    [_hud setDimBackground:YES];
    
    PFObject *saveCasePreview = (PFObject *)_detailItem;
    [saveCasePreview setObject:_textView.text forKey:@"askNote"];
